...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.resizable(0 , 0)
        top.title("Python to analysis code")
        top.configure(background="#6f6fdf")
        ...
        self.Label1.configure(text='''Open python file''')
        ...
        self.Button2.configure(text='''Convert Python Code''')

def start_up():
    python_to_analysis_code_support.main()
