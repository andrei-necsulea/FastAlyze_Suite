...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.resizable(0 , 0)
        top.title("Figure to Code")
        top.configure(background="#6fc6df")
        ...
        self.TEntry1.place(relx=0.35, rely=0.288, relheight=0.069
                , relwidth=0.46)
        ...
        self.Button1.place(relx=0.83, rely=0.288, height=34, width=47)
        ...
        self.Label1.place(relx=0.05, rely=0.288, height=31, width=160)
        self.Label1.configure(activebackground="#f9f9f9")
        self.Label1.configure(background="#6fc6df")
        ...
        self.Label1.configure(text='''Figure Location''')
        ...
        self.Button2.configure(text='''Convert Figure''')

def start_up():
    figure_to_code_support.main()
