...
def bar_of_pie():
 ...
 def create_bar_of_pie(explode_param , pie_labels_param , bar_labels_param , bar_ratios_param , master_wedge_pos):
  if len(return_df_stacked_plot()) >= 1 :
      ...
      pie_ratios = list(return_df_stacked_plot())
      pie_ratios = pie_ratios[len(pie_ratios)-1]
      #de revizuit .. e ceva cu ordinea numerelor
      ...
      angle = -180*percents[master_wedge_pos]/100
 ...
 window.title("BAR of PIE properties")
 ...
 lbl_2.place(relx = 0.2 , rely = 0.3)
 lbl_2.config(background="#9fb49f")

 lbl_3 = tk.Label(window , text = "Bar labels : ")
 lbl_3.place(relx = 0.2 , rely = 0.4)
 lbl_3.config(background="#9fb49f")

 lbl_4 = tk.Label(window , text = "Bar data : ")
 lbl_4.place(relx = 0.2 , rely = 0.5)
